...
import './assets/css/stylesFooterGlobal.css';

export function FooterGlobal() {
    return (
        <section className='lSectionFooterGlobal'>
            <div className='containerFooterGlobal'>
                <div className="footerGrid">
                    <div className='divLogoMountChuchFooter'>
                        <img src={logoWhite} className="LogoMountChuchFooter" alt='logo Mount Church' />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className='subTileFooter cursor-pointer'
                            ...
                            E-mail: secretaria@mountchurch.com.br
                        </div>
                        <div className='flex space-x-4 mb-8'>
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    className="h-7 w-7 hoverColorFacebookFooter"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            <div className='cursor-pointer'
                                onClick={() => window.open(`https://www.instagram.com/mount.church/`, '_blank')}
                            >
                                {/* <!-- Instagram --> */}
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-7 w-7 hoverColorInstagramFooter"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            >
                                ...
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-7 w-7 hoverColorYoutubeFooter"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            >
                                ...
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-7 w-7 hoverColorWhatsappFooter"
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
