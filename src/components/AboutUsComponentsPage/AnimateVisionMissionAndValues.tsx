                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <div>
                                ...
                                <p className="textAnimateVisionMissionAndValues" >
                                    Amor, serviço, integridade, comunhão e missão são os valores centrais que nos guiam. Cada um desses princípios é vital para nosso <strong>ministério</strong> e definem a forma como interagimos com nossa comunidade e além.
                                </p>
                            </div>
                        </motion.div>
                    </AnimatePresence>
