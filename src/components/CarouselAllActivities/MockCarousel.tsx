...
const ministriesOrActivitiesMock = [
    {
        ...
        infoDescription: 'Realizamos encontros nas casas de nossos anfitriões <strong>uma vez por semana</strong>, sempre às <strong>terças-feiras às 20h</strong>. As conexões acontecem nos principais bairros da cidade compartilhando a palavra de Deus e promovendo um ambiente acolhedor para o crescimento espiritual. ',
    ...
    },
    {
        ...
        infoDescription: 'Gostaríamos de convidar você para participar do<strong>One</strong>!!🔥Aqui é um espaço de amizade, crescimento espiritual e muita alegria. Juntos, buscamos fortalecer nossa fé, compartilhar experiências e caminhar com Deus em cada etapa de nossas vidas.<br><br>Venha com o coração aberto para viver momentos de comunhão, diversão e aprendizado.',
        ...
        services: [
            {
                id: 1,
                title: 'Comunhão e Fé',
                description: 'O culto de jovens é um momento vibrante,cheio de alegria com louvores contagiantes e palavras inspiradoras que se unem para tocar <strong>corações</strong>!',
                image: CultoOne,
            },
            {
                id: 2,
                title: 'Conversas à Mesa',
                description: 'Nesse ambiente acolhedor, amigos se reúnem entre <strong>refeições</strong> para conversar sobre <strong>Deus</strong> e compartilhar experiências.',
                image: ComidaOne,
            },
            {
                id: 3,
    ...
    },
    {
        ...
        infoDescription: 'Por toda a cidade de <strong>Joinville</strong> uma mesa com o <strong>Senhor</strong> será montada para contemplar aquilo que <strong>Jesus</strong> faz em nossas vidas, esse é o objetivo do ministério de mulheres. Um momento para dividir <strong>experiências</strong>,<strong> testemunhos</strong> e criar<strong> laços</strong>! Café, mulheres e palavra de <strong>Deus</strong>, uma perfeita combinação.</br> Um momento de aproximação afim de que outras mulheres possam ser <strong>amigas</strong> de Jesus e umas das outras.</br></br> Veja uma mais <strong>próxima</strong> de você!',
        infoImage: MulheresImg,
        joinTheGroupTitle: 'A Força da Oração Feminina',
        firstDescriptionjoinTheGroup: 'A oração é uma das maiores dádivas que Deus nos deu, e a oração de uma mulher tem um poder especial. Em nossos cultos de mulheres, você encontrará um ambiente acolhedor e inspirador, onde cada mulher é incentivada à buscar a Deus com todo o seu coração. Estes cultos são momentos de renovação espiritual, onde compartilhamos testemunhos, aprendemos juntas e fortalecemos nossa fé.',
    ...
    },
    {
        ...
        secondDescriptionjoinTheGroup: '<strong>Jiu-Jitsu</strong>: Segundas e Quartas-feiras, kids 9 a 12 anos as 19h, adultos a partir de 13 anos as 20h;<br><strong>Muay Thai</strong>: Quartas-feiras, às 19h30, a partir dos 13 anos;<br><strong>Futebol</strong>: Segundas-feiras, das 21h às 22h (<strong>A atividade de futebol não é gratuita; também é necessário verificar o local de encontro clicando em "Mais informações".</strong>).',
    ...
    },
    {
        ...
        mockType: 'Ministérios',
        title: 'Dança',
        description: 'O ministério de dança <strong>adora a Deus</strong> através da <strong>expressão corporal</strong>.',
        image: DancaCardImg,
        link: 'https://seu-site.com/danca',
        infoTitle: 'Movimentos de Adoração',
        infoDescription: 'No <strong>Ministério de Dança</strong>, acreditamos que “Tudo é movimento.” Seja um andar, saltar, levantar de braços, girar. E nós, nos movemos pela voz do <strong>Espírito Santo</strong>. Isso é o que nos diferencia do mundo! É Ele quem direciona os nossos passos e traz vida a cada movimento.',
        ...
        services: [
            ...
            },
            {
                ...
                description: 'A dança é uma expressão de graça e beleza, refletindo a glória de Deus. Nossos bailarinos são guiados pelo Espírito Santo para transmitir a mensagem de amor e esperança.',
