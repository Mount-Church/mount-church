...
const ministriesOrActivitiesMock = [
    ...
    },
    {
        ...
        mockType: 'Ministérios',
        title: 'Mulheres',
        description: 'Encontro <strong>mensal</strong> de <strong>Mulheres</strong>.',
